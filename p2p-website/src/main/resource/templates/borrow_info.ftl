				...
				<div class="col-sm-3">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<p class="text-center">
								<a class="text-info" href="#">${bidRequest.createUserId.username}</a>
							</p><br />
							<div>
							 	籍贯： 四川 - 成都
							 </div>
					...
					<table style="height:110px;width:230px;">
						...
						<tr>
							...
							<div style="margin-bottom: 10px;" class="progress">
								<div style="width: ${bidRequest.persent}%" class="progress-bar progress-bar-info progress-bar-striped active">
									${bidRequest.persent}%
								</div>
							</div>
							</td>
