...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-sm-9">
            ...
            <input type="hidden" id="username" name="username" value="${qo.username}" />
                <div class="form-group">
                    <label>时间范围</label>
                    <input type="text" onclick="WdatePicker()" class="form-control beginDate" name="beginTime" value='${(qo.beginTime?string("yyyy-MM-dd"))!""}'/>
                </div>
                <div class="form-group">
                    <label></label>
                    <input type="text" onclick="WdatePicker()" class="form-control endDate" name="endTime" value='${(qo.endTime?string("yyyy-MM-dd"))!""}'/>
                </div>
                <div class="form-group">
                    <label>状态</label>
